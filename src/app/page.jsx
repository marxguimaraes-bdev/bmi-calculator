  ...
  return (
    <main className='flex flex-col font-custom min-h-screen items-center bg-pure-white gap-y-10 pb-10'>
      <section title="Body Mass Index Calculator" className="flex flex-col w-full lg:overflow-visible lg:flex-row lg:px-6">
        <div className="flex flex-col items-center gap-y-6 text-center rounded-b-heading p-6 min-h-[40rem] bg-gradient-to-tl from-[#D6E6FE] to-[#D6FCFE] lg:py-[4.47rem] md:px-22 lg:pl-[7.25rem] lg:pr-[18.625rem] lg:max-w-[61.125rem] lg:h-[46.0625rem] lg:items-start lg:text-left">
