...
export default function IndexPage() {
  return (
    <div class="bg-pure-white">
      <main className='flex flex-col font-custom items-center bg-pure-white xl:max-w-[90rem] xl:mx-auto pb-[96px] xl:pb-[120px]'>
        <section title="Body Mass Index Calculator" className="flex flex-col w-full xl:overflow-visible xl:flex-row">
          <div className="flex flex-col items-center text-center rounded-b-heading min-h-[40rem] bg-gradient-linear pr-[24px] pl-[24px] sm:pr-[43px] sm:pl-[39px] xl:pl-[7.25rem] xl:min-w-[978px] xl:h-[46.0625rem] xl:items-start xl:text-left">
            <Image src="/images/logo.svg" width={40} height={40} alt="Company logo" className="xl:w-[4rem] xl:h-[4rem] mt-[32px] sm:mt-[34px] xl:mt-[75px]" />
            <h1 className="text-gunmetal text-heading-l leading-heading font-semibold xl:text-heading-xl mt-[24px] sm:mt-[42px] xl:mt-[127px] sm:max-w-[380px] xl:max-w-[564px] xl:pr-[48px]">
              Body Mass Index Calculator
            </h1>
            <div className="text-dark-electric-blue leading-body xl:max-w-[465px] mt-[24px] xl:mt-[35px]">
        ...
        <section title="What your BMI result means" className={`
          grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 w-full sm:px-[2.6875rem] xl:px-[8.75rem] gap-y-8 xl:gap-y-[2.1875rem]
          mt-[72px] sm:mt-[96px] xl:mt-[65px]
        `}>
        ...
        <section title="Health tips" className={`
          ...
          mt-[72px] py-[56px] pl-[19px] pr-[29px]
          sm:mt-[96px] sm:py-[60px] sm:pl-[39px] sm:pr-[43px]
        ...
        <section title="Limitations of BMI" className={`
          ...
          mt-[72px] pl-[19px] pr-[29px]
          sm:mt-24 sm:pl-[39px] sm:pr-[43px]
          xl:mt-[120px] xl:pr-0 xl:pl-0
        `}>
          ...
          <SmallCard icon="/images/icon-gender.svg" alt="Mars and venus icon" title="Gender" className="xl:col-start-3 sm:justify-self-end xl:mb-[12px] xl:justify-self-end xl:mr-[239px]">
            The development and body fat composition of girls and boys vary with age. Consequently, a child's age and gender are considered when evaluating their BMI.
          </SmallCard>
          <SmallCard icon="/images/icon-age.svg" alt="Cake icon" title="Age" className="xl:col-start-1 sm:justify-self-start xl:justify-self-start xl:ml-[538px]">
            In aging individuals, increased body fat and muscle loss may cause BMI to underestimate body fat content.
          </SmallCard>
          <SmallCard icon="/images/icon-muscle.svg" alt="Biceps icon" title="Muscle" className="xl:col-start-3 sm:justify-self-end xl:justify-self-end xl:mr-[140px]">
            BMI may misclassify muscular individuals as overweight or obese, as it doesn't differentiate muscle from fat.
          </SmallCard>
          <SmallCard icon="/images/icon-pregnancy.svg" alt="Baby icon" title="Pregnancy" className="xl:col-start-1 sm:justify-self-start xl:justify-self-start xl:ml-[339px]">
            Expectant mothers experience weight gain due to their growing baby. Maintaining a healthy pre-pregnancy BMI is advisable to minimise health risks for both mother and child.
          </SmallCard>
          <SmallCard icon="/images/icon-race.svg" alt="Person icon" title="Race" className="sm:!w-[365px] sm:col-span-2 xl:col-span-1 sm:justify-self-center sm:col-start-1 xl:col-start-3 xl:justify-self-end xl:mr-[339px]">
