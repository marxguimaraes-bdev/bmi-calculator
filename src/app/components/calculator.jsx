...
function Calculator() {
  ...
  return (
    <div className="flex flex-col gap-y-6 lg:gap-y-8 mx-5 -mt-[45%] bg-pure-white text-gunmetal drop-shadow-custom rounded-calculator p-6 md:-mt-[35%] lg:mt-[10.4375rem] lg:-ml-[16.625rem] lg:w-[35.25rem] lg:h-fit lg:p-8">
